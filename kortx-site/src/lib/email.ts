    ...
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: #0A1628; padding: 24px; text-align: center;">
          <h1 style="color: #00A3FF; margin: 0; font-size: 24px;">KORT.X</h1>
        ...
        <div style="padding: 24px; background: #ffffff;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr><td style="padding: 8px 0; color: #64748B;">Email</td><td style="padding: 8px 0;"><a href="mailto:${data.email}" style="color: #00A3FF;">${data.email}</a></td></tr>
    ...
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 24px; background: #ffffff;">
          ...
          <p style="color: #64748B; line-height: 1.6;">
            Enquanto isso, conheça mais sobre nosso trabalho em <a href="https://kortx.pro" style="color: #00A3FF;">kortx.pro</a>.
          </p>
